...
#        client = web.service.github.api.v3.Client.Client(db, authData, repo=repo)
#        client = web.service.github.api.v3.Client.Client(authData, repo=repo)
...
#        main = cui.uploader.Main.Main(db, client, repo)
        main.Run()
